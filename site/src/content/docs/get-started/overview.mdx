...
[layout rhythm](/lemonade-design-system/layout/rhythm/) everything sits on.

#### Patterns

Whole solutions rather than parts — a
[list screen](/lemonade-design-system/patterns/lists/), an
[empty state](/lemonade-design-system/patterns/empty-and-loading/) — assembled from
components with the decisions written down.
