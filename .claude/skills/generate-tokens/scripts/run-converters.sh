...
converters_for() {
  case "$1" in
    ...
    theme-colors.light.tokens.json|theme-colors.dark.tokens.json)
                                  echo "kmp-theme-token-converter swiftui-theme-token-converter swiftui-color-assets-generator kmp-themed-token-converter swiftui-themed-token-converter swiftui-themed-assets-generator web-token-converter web-llms-txt-converter web-css-bundle" ;;
